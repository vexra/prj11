                        ...
                        <div class="card-body">
                            <table class="table table-hover">
                                ...
                                <tbody>
                                  <tr>
                                    <th scope="row">1</th>
                                    <td>SMA Kebangsaan Lampung Selatan (A)</td>
                                  </tr>
                                  <tr>
                                    <th scope="row">2</th>
                                    <td>SMA Xaverius BDL</td>
                                  </tr>
                                  <tr>
                                    <th scope="row">3</th>
                                    <td>SMAN 9 BDL</td>
                            ...
                            <table class="table table-hover">
                                ...
                                <tbody>
                                  <tr>
                                    ...
                                    <td class="text-center align-middle" rowspan="2">SMA Negeri 1 Gedong Tataan</td>
                                    <td>M. Ilham Falikh</td>
                                  </tr>
                                  <tr>
                                    <td>Bella Chintya Rahmawati</td>
                                  </tr>
                                  <tr>
                                    <td class="text-center align-middle" scope="row" rowspan="2">2</td>
                                    <td class="text-center align-middle" rowspan="2">SMK Pelita Pesawaran</td>
                                    <td>Daffa Erlangga Johan</td>
                                  </tr>
                                  <tr>
                                    <td>Erint Ramadhani</td>
                                  </tr>
                                  <tr>
                                    <td class="text-center align-middle" scope="row" rowspan="2">3</td>
                                    <td class="text-center align-middle" rowspan="2">SMAK BPK Penabur BDL</td>
                                    <td>Dennis Rafael</td>
                                  </tr>
                                  <tr>
                                    <td>Loriensia Lieviana</td>
                                  </tr>
                                </tbody>
                              </table>
                        </div>
                        <div class="card-body">
                            ...
                            <table class="table table-hover">
                                ...
                                <tbody>
                                  ...
                                  <tr>
                                    <th scope="row">2</th>
                                    <td>SMAN 1 Way Jepara</td>
                                    <td>Raditya</td>
                                  </tr>
                                  <tr>
                                    <th scope="row">3</th>
                                    <td>SMA 2 Pesawaram</td>
