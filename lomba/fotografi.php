                ...
                <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.5s">
                    <div class="h-100">
                        ...
                        <div class="row g-2 mb-4 pb-2">
                            <div class="col-sm-10">
                                <i class="bi bi-award me-2" style="color: rgb(214, 175, 54)"></i>Juara 1 : Rp. 750.000
                            </div>
                            <div class="col-sm-10">
                                <i class="bi bi-award me-2" style="color: rgb(167, 167, 173)"></i>Juara 2 : Rp. 500.000
                            </div>
                            <div class="col-sm-10">
                                <i class="bi bi-heart me-2" style="color: rgb(152, 0, 46)"></i>Juara Favorit : Rp. 250.000
                            </div>
                        </div>
                        <div class="row g-4">
                            <div class="col-sm-6">
