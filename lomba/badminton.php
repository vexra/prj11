    ...
    <div class="container">
        <div class="row g-5">
            <div class="col-lg-6 wow fadeInUp content-cpc" data-wow-delay="0.1s">
                <h6 class="text-primary text-uppercase mb-2">Badminton</h6>
                ...
                <div class="col-lg-4 wow fadeIn" data-wow-delay="0.1s">
                    <div class="bg-white shadow d-flex align-items-center h-100 p-4" style="min-height: 150px;">
                        <div class="d-flex">
                            ...
                            <div class="ps-4">
                                <h5>Pendaftaran</h5>
                                <span>Pendaftaran dilaksanakan pada 5 September - 20 Oktober 2022.</span>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="row g-5">
                <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="position-relative overflow-hidden ps-5 pt-5 h-100" style="min-height: 400px;">
                        <img class="position-absolute w-100 h-100" src="img/badminton.jpg" alt="" style="object-fit: cover;">
                    </div>
                </div>
                <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.5s">
                    <div class="h-100">
                        ...
                        <div class="row g-4">
                            <div class="col-sm-6">
                                <a class="btn btn-primary py-3 px-5" href="formPilihBadminton.php">Daftar</a>
                            </div>
                            <div class="col-sm-6">
